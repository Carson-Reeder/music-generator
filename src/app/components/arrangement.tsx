                ...
                {stores.map(({ id, store }) => (
                    <div key={id}>
                        <div style={{margin: "10px", padding: "10px" }}>
                            ...
                            <button className='ml-5 mr-2 items-center pr-1 pl-1 pt-1 rounded-sm' style={{ backgroundColor: 'rgba(1, 255, 158, 0.12)',
                    outline: '0.1rem solid #1E291E', borderRadius: '0.5rem'
                 }} onClick={() => removeComposition(id)}>Delete</button>
                        </div>
                    </div>
                ))}
                <button className='ml-5 mr-2 items-center pr-1 pl-1 pb-1 rounded-sm mb-8' style={{ backgroundColor: 'rgba(1, 255, 158, 0.12)',
                    outline: '0.1rem solid #1E291E', borderRadius: '0.5rem'
                 }} onClick={addComposition}>Add New Composition</button>   
            </div>
        </div>
    );
