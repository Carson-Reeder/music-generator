...
export async function POST(request: Request) {
  try {
    ...
    const response = await openai.responses.create({
      ...
      instructions:
        "You are an expert, highly creative music theory assistant that generates dynamic, interesting chord progressions. " +
      ...
      input: (contextTracks && contextTracks.length > 0)
